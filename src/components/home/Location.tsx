      ...
      <div className="shell grid gap-12 lg:grid-cols-[1.1fr_1fr]">
        <div>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-8 inline-flex h-12 items-center gap-2 rounded-md bg-charcoal-deep px-6 text-sm font-extrabold text-cream transition-transform hover:-translate-y-0.5"
          >
